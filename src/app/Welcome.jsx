...
function Welcome() {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center gap-10 px-4">
      ...
      >
        <h2 className="text-black text-2xl font-semibold">Moderator Setup</h2>
      </button>
      <button>
        <h2
          className="text-white text-2xl font-semibold mt-6 underline animate__animated animate__pulse animate__repeat-3 cursor-pointer"
          onClick={() => {
            navigate("/joinGame");
          }}
        >
